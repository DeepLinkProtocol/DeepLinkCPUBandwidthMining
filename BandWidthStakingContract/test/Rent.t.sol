...
import {NFTStakingState} from "../src/NFTStakingState.sol";
...
contract RentTest is Test {
    ...
    function testRentMachine() public {
        ...
        (NFTStakingState.StakeHolder[] memory topStakeHolders, uint256 total) = nftStaking.getTopStakeHolders(0, 10);
        assertEq(total, 1);
    ...
    function testGetMachinePrice() public {
        ...
        nftStaking.stake(owner, machineId, nftTokens, nftTokensBalance);
